...
import { LayoutDashboard, Users, Banknote, Clock, Settings, LogOut, MessageSquare, FileText, Receipt, FileOutput, Award, Gift, Wallet, HandCoins } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Pinjaman', icon: HandCoins, href: '/kasbon' },
